\section{Static and Query-time Optimizers}
\label{s:costmodel}
...
%Due to space
%constraints, we do not describe the cost models. 



\subsection{Lineage Strategy Optimizer}

%We now turn to the problem of deciding how to assign {\it storage strategies}
%(i.e., input and output encodings) to each operator in a workflow prior to
%executing it.  
